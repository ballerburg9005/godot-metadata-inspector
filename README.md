...
*Pro tip:* You can open the Project's .tscn files with a text editor and edit the \_\_meta\_\_ dictionary as plain text. In case you need to e.g. completely restructure your data or using the GUI is somehow inconvenient.
